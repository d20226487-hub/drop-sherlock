      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>Нет</td>
            <td>
              Свободный текст. Тег партии / клиента / задачи. Не влияет
              на анализ, но индексируется поиском на Очереди и Базе.
              Авто-маппится из заголовков, содержащих{" "}
              <code>project</code> / <code>campaign</code>.
            </td>
          </tr>
          <tr>
